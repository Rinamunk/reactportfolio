...
export default function Hjem() {
     ...
     const artPic = "data:../src/assets/artjourney.png";
  ...
  return (
      ...
      <main>
        ...
        <Typography variant="h1">Velkommen!</Typography>
          ...
          <img src="../rina.jpg" alt="Rina" className="profile" />
        ...
        <Stack direction="row" spacing={2} display={"flex"} flexWrap={"wrap"}>
          ...
          />
            <Actioncard
            image="../src/assets/streetfood.png"
          ...
          />
            <Actioncard
            image="../src/assets/logomedova.png"
            title="Medova Te"
